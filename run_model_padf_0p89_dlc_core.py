...
if __name__ == '__main__':
    ...
    #
    modelp.xyz_name = "2018812_xH.xyz"  # the xyz file contains the cartesian coords of the crystal
    ...
    #
    modelp.subject_atom_name = "2018812_xH.xyz"  # the cif containing the asymmetric unit
    ...
    #
    modelp.ucds = [800.192, 800.192, 800.933, 90.0000, 90.0000, 90.0000]
