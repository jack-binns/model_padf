...
if __name__ == '__main__':
    ...
    for probe in probes:
        ...
        #
        modelp.project = f"ordered_xfmmatch\\"

        #
        # a meaningful sample tag
        #
        modelp.tag = "zif8_ordered"

        #
        # name of .xyz file containing all the atomic coordinates
        #
        modelp.xyz_name = "zif8_ordered_sc-12-12-12.xyz"  # the xyz file contains the cartesian coords of the crystal
        ...
        #
        modelp.subject_atom_name = "zif8_au.xyz"  # the cif containing the asymmetric unit
