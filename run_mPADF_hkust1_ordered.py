...
if __name__ == '__main__':
    ...
    for probe in probes:
        ...
        #
        modelp.tag = "hkust1_ordered"

        #
        # name of .xyz file containing all the atomic coordinates
        #
        modelp.xyz_name = "hkust1_2x2x2sc.xyz"  # the xyz file contains the cartesian coords of the crystal
        ...
        #
        modelp.subject_atom_name = "hkust1_as.xyz"  # the cif containing the asymmetric unit
