...
if __name__ == '__main__':
    ...
    for probe in probes:
        ...
        #
        modelp.project = f"k_phase_2disks\\"

        #
        # a meaningful sample tag
        #
        modelp.tag = "dlc_2disks"

        #
        # name of .xyz file containing all the atomic coordinates
        #
        modelp.supercell_atoms = "dlc_2disks.xyz"  # the xyz file contains the cartesian coords of the crystal
        ...
        #
        modelp.subject_atoms = "dlc_2disks.xyz"  # the cif containing the asymmetric unit
