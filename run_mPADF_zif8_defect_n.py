...
if __name__ == '__main__':
    ...
    for probe in probes:
        ...
        #
        modelp.tag = "zif8_defect_n"

        #
        # name of .xyz file containing all the atomic coordinates
        #
        modelp.xyz_name = "12hSAW_Equ2_005_LV_ISIF2D3opt_sc.xyz"  # the xyz file contains the cartesian coords of the crystal
        ...
        #
        modelp.subject_atom_name = "12hSAW_Equ2_005_LV_ISIF2D3opt_as.xyz"  # the cif containing the asymmetric unit
