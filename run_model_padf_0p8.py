...
import parallel_model_padf_0p85 as pmp
...
if __name__ == '__main__':
    ...
    #
    modelp.project = "graphite\\"

    #
    # name of .xyz file containing all the atomic coordinates
    #
    modelp.supercell_atoms = "graphite.xyz"  # the xyz file contains the cartesian coords of the crystal structure expanded to include r_probe

    #
    # crystallographic file with unit cell information
    #
    modelp.subject_atoms = "graphite.cif"  # the cif containing the asymmetric unit. This often needs to be edited for PDB CIFs hence '_edit' here

    #
    # Unit cell parameters (a,b,c,alpha,beta,gamma)
    #
    modelp.ucds = [2.45600, 4.25400, 6.69600,  90.0000,  90.0000,  90.0000]
