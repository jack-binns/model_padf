...
if __name__ == '__main__':
    ...
    for probe in probes:
        ...
        #
        modelp.root = "E:\\hexamine_model_study\\m93u_convergence\\"

        #
        # this is a directory for this specific project
        #
        modelp.project = f"{probe}_8_u_nocon\\"
        # modelp.project = f"{probe}_ang_nocon_trim_1\\"

        #
        # a meaningful sample tag
        #
        modelp.tag = f"hexamine_{probe}"

        #
        # name of .xyz file containing all the atomic coordinates
        #
        modelp.xyz_name = "gr0219_5x5x5.xyz"  # the xyz file contains the cartesian coords of the crystal
        ...
        #
        modelp.subject_atom_name = "gr0219_as.xyz"  # the cif containing the asymmetric unit
