...
if __name__ == '__main__':
    ...
    for probe in probes:
        ...
        #
        modelp.project = f"k_phase_86ang_cg\\"
        ...
        #
        modelp.supercell_atoms = "dlc_condens_21_sc6136.xyz"  # the xyz file contains the cartesian coords of the crystal
        ...
        #
        modelp.subject_atoms = "dlc_condens_21_as.xyz"  # the cif containing the asymmetric unit
