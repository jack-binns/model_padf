...
if __name__ == '__main__':
    ...
    for probe in probes:
        ...
        #
        modelp.project = f"k_phase_single_disk\\"

        #
        # a meaningful sample tag
        #
        modelp.tag = "dlc_single_disk"

        #
        # name of .xyz file containing all the atomic coordinates
        #
        modelp.supercell_atoms = "dlc_single_disk.xyz"  # the xyz file contains the cartesian coords of the crystal
        ...
        #
        modelp.subject_atoms = "dlc_single_disk.xyz"  # the cif containing the asymmetric unit
