...
if __name__ == '__main__':
    ...
    for probe in probes:
        ...
        #
        modelp.project = f"dh_model1_as\\"
        # modelp.project = f"{probe}_ang_nocon_trim_1\\"

        #
        # a meaningful sample tag
        #
        modelp.tag = f"dh_mod1"

        #
        # name of .xyz file containing all the atomic coordinates
        #
        modelp.xyz_name = "dh_sc.xyz"  # the xyz file contains the cartesian coords of the crystal
        ...
        #
        modelp.subject_atom_name = "dh_as.xyz"  # the cif containing the asymmetric unit
