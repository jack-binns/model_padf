...
import parallel_model_padf_0p88 as pmp
...
if __name__ == '__main__':
    ...
    modelp.root = "G:\\RMIT\\erythrocruorin\\"
    ...
    #
    modelp.xyz_name = "2gtl_80.xyz"  # the xyz file contains the cartesian coords of the crystal
    ...
    #
    modelp.subject_atom_name = "2gtl_80.xyz"  # the cif containing the asymmetric unit
