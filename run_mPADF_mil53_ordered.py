...
if __name__ == '__main__':
    ...
    for probe in probes:
        ...
        #
        modelp.root = "E:\\RMIT\\mofs_saw\\MIL53_mPADF\\"
        ...
        #
        modelp.tag = "MIL53_ordered"

        #
        # name of .xyz file containing all the atomic coordinates
        #
        modelp.xyz_name = "MIL53_ordered-12-23-12.xyz"  # the xyz file contains the cartesian coords of the crystal
        ...
        #
        modelp.subject_atom_name = "MIL53_ordered_au.xyz"  # the cif containing the asymmetric unit
        ...
        modelp.convergence_target = 1E-5
