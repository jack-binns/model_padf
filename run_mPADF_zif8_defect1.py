...
if __name__ == '__main__':
    ...
    for probe in probes:
        ...
        #
        modelp.project = f"defect1\\"

        #
        # a meaningful sample tag
        #
        modelp.tag = "zif8_defect1"

        #
        # name of .xyz file containing all the atomic coordinates
        #
        modelp.xyz_name = "zif8_defect1_sc-12-12-12.xyz"  # the xyz file contains the cartesian coords of the crystal
        ...
        #
        modelp.subject_atom_name = "12hSAW_Equ2_005_LV_ISIF2D3opt_snapped_sniped.xyz"  # the cif containing the asymmetric unit
