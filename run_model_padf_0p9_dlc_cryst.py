...
import parallel_model_padf_0p9 as pmp
...
if __name__ == '__main__':
    ...
    #
    modelp.xyz_name = "1168139_sc.xyz"  # the xyz file contains the cartesian coords of the crystal
    ...
    #
    modelp.subject_atom_name = "1168139_as.xyz"  # the cif containing the asymmetric unit
    ...
    #
    modelp.ucds = [800.0, 800.0, 800.0, 90.0000, 90.0000, 90.0000]
