...
class ModelPADF:
    ...
    def __init__(self):
        ...
        # to include r_probe
        self.subject_atom_name = "1al1_edit.cif"  # the cif containing the asymmetric unit. This often needs to be edited for
    ...
    def run_stm(self):
        ...
        self.asymm = subject_atom_reader(self.root + self.project + self.subject_atom_name,
